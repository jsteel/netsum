...
#define IPOQUE_PROTOCOL_TCP						96
#define IPOQUE_PROTOCOL_UDP						97


#define IPOQUE_LAST_IMPLEMENTED_PROTOCOL        97
...
#define IPOQUE_PROTOCOL_LONG_STRING "unknown","FTP","Mail_POP","Mail_SMTP","Mail_IMAP","DNS","IPP","HTTP","MDNS","NTP",\
	...
	"IP in IP","RTP","RDP","VNC","PCAnywhere","SSL","SSH","USENET","MGCP",\
    "IAX","unknown TCP","unknown UDP"
#define IPOQUE_PROTOCOL_SHORT_STRING "ukn","ftp","pop","smtp","imap","dns","ipp","http","mdns","ntp","netbios","nfs","ssdp",\
	...
	"ipsec","gre","icmp","igmp","egp","sctp","ospf","ipip","rtp","rdp","vnc","pcanywhere","ssl","ssh","usenet","mgcp","iax","ukntcp","uknudp"
